    ...
    switch (level) {
      case 'low':
        return {
          ...
          suggestions: ['保持与债权方的正常沟通：定期主动联系债权方，说明还款意愿和计划，避免失联', '制定合理的还款计划：根据收入情况，制定可执行的月度还款计划，优先偿还高利率债务', '保留所有沟通记录：保存通话录音、短信、邮件等沟通记录，以备不时之需', '建立紧急备用金：每月预留收入的5-10%作为应急资金，应对突发情况', '关注征信报告：定期查询个人征信报告，确保还款记录准确无误', '避免新增债务：在还清现有债务前，避免申请新的贷款或信用卡', '学习理财知识：通过书籍、课程等途径提升理财能力，避免再次陷入债务危机']
        };
      case 'medium':
        return {
          color: '#F59E0B',
          ...
          suggestions: ['主动联系债权方说明情况：在逾期前主动联系，说明暂时困难，表达还款意愿', '准备详细的财务状况说明：整理收入证明、支出明细、资产负债表等材料', '了解协商还款的可能性：询问是否可以延期还款、分期还款、减免利息等方案', '注意保留所有证据：保存所有沟通记录、催收短信、通话录音等，作为维权依据', '寻求专业债务咨询：可咨询专业的债务管理机构或律师，了解债务重组方案', '评估债务优先级：按照利率高低、逾期时间、法律风险等因素确定还款优先顺序', '考虑债务整合：如有多笔债务，可考虑债务整合贷款，降低利息负担', '避免过度消费：严格控制非必要支出，将更多资金用于偿还债务', '了解法律保护：学习相关法律法规，了解自己的合法权益和维权途径', '保持心理健康：债务压力可能影响心理健康，必要时寻求心理咨询']
        };
      case 'high':
        return {
          color: '#EF4444',
          ...
          suggestions: ['立即咨询专业律师：寻找擅长债务纠纷的律师，了解法律程序和维权途径', '收集和保存所有相关证据：包括借款合同、还款记录、催收短信、通话录音、邮件等', '了解法律程序和您的权利：学习民法典、个人信息保护法等相关法律，了解自己的权利', '避免做出任何可能加重风险的承诺：不要签署不了解的文件，不要承诺无法履行的还款计划', '如遇违法催收，及时投诉：向银保监会、公安机关、消费者协会等监管部门投诉', '评估破产可能性：如债务确实无法偿还，可咨询律师了解个人破产的法律程序', '保护个人信息安全：不要向非官方渠道提供个人信息，警惕诈骗', '与家人沟通：与家人坦诚沟通债务情况，寻求理解和支持', '制定长期还款计划：在律师指导下，制定切实可行的长期还款计划', '关注法律时效：了解诉讼时效、执行时效等法律规定，避免错过维权时机', '准备应诉材料：如已被起诉，准备答辩状、证据清单等应诉材料', '寻求法律援助：如经济困难，可申请法律援助，获得免费法律服务']
        };
      default:
        return null;
    }
